...
//        User::create(["identity" => "100005965563483", "username" => "ck.mua.3", "fullname" => "Pi's Pôlyme's", "gender" => "MALE", "location" => "Tây Ninh", "hometown" => "Tây Ninh", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs(), 'email' => 'ck.mua.3@gmail.com']);
//        User::create(["identity" => "100001034249186", "username" => "xnohat", "fullname" => "Hong Phuc Nguyen", "gender" => "MALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100000001339582", "username" => "Singer.VanMaiHuong", "fullname" => "Văn Mai Hương", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Hanoi, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "1140177709", "username" => "1140177709", "fullname" => "Duy Nguyễn", "gender" => "MALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100001349889094", "username" => "kimdungdao85", "fullname" => "Đào Kim Dung", "gender" => "FEMALE", "location" => "Hanoi, Vietnam", "hometown" => "Ha-Nam, Hà Nam, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs(), 'kimdungdao85@gmail.com']);
//        User::create(["identity" => "709234645", "username" => "traanf", "fullname" => "Tran Tuan Anh", "gender" => "MALE", "location" => "Hanoi, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100004744954014", "username" => "chi1bro", "fullname" => "Huyen Chip", "gender" => "FEMALE", "birthday" => "1990", "location" => "Hanoi, Vietnam", "hometown" => "Hai Hau", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
...
//        User::create(["identity" => "100004237386927", "username" => "katie.kieu.3", "fullname" => "Lê Thị Thuý Kiều", "gender" => "FEMALE", "birthday" => "1986", "location" => "Thành phố Hồ Chí Minh, Hồ Chí Minh, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100000001126549", "username" => "hien.do.9022", "fullname" => "Hien Do", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Thái Bình", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "1810181763", "username" => "mthuy232", "fullname" => "Minh Thúy Nguyễn", "gender" => "FEMALE", "birthday" => "1989", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100004507470778", "username" => "lucy.nguyen.5680", "fullname" => "Hien Nguyen Ngoc", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Phu Nhuan, Hồ Chí Minh, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100001528376207", "username" => "trang.vole", "fullname" => "Trang Vo Le", "gender" => "FEMALE", "birthday" => "1977", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Nha Trang, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "1015572957", "username" => "sieutraubo", "fullname" => "Nguyễn Phương Thảo", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Athens, Greece", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "737522356", "username" => "pham.duong", "fullname" => "Pham An Duong", "gender" => "MALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100003242027429", "username" => "vienha.nguyenthuy", "fullname" => "Nguyễn Thụy Viễn Hạ", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Lái Thiêu", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100005474493537", "username" => "nguyenphuong.thuy.798", "fullname" => "Thúy Nguyễn", "gender" => "FEMALE", "location" => "Ninh Bình", "hometown" => "Ninh Bình", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100002328571138", "username" => "thaimeo0705", "fullname" => "Thái Mèo", "gender" => "MALE", "location" => "Thanh Hóa", "hometown" => "Thanh Hóa", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100004699361218", "username" => "99c100880", "fullname" => "Đình Khôi", "gender" => "MALE", "birthday" => "1991", "location" => "Bac Ninh", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100004943444187", "username" => "thangpro.xeroxy92", "fullname" => "Huỳnh Quang Thắng", "gender" => "MALE", "birthday" => "1992", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Binh Dinh, Nghia Binh, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "1205312178", "username" => "Willie.be.nho", "fullname" => "Phung Dan Truong", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "1589070142", "username" => "Ms.Phuong", "fullname" => "Thùy Phương", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Tuy Hòa", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100001735773766", "username" => "thuongthuong.iuiu", "fullname" => "Nguyễn Hoài Thương", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Bak Nin, Bắc Ninh, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
...
//        User::create(["identity" => "100004087537304", "username" => "ngoclam.tran.79", "fullname" => "Ngoc Lam Tran", "gender" => "MALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Quang Ngai", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100004510534129", "username" => "trang.vo.3705157", "fullname" => "Trang Võ", "gender" => "FEMALE", "birthday" => "1984", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100000106878122", "username" => "lehongvan9183", "fullname" => "Vân Lê Hồng", "gender" => "FEMALE", "birthday" => "1983", "location" => "Kim Mã, Ha Noi, Vietnam", "hometown" => "Hoài Nhon, Bình Ðịnh, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100000786663511", "username" => "anh.vy.9", "fullname" => "Anh Vy", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
...
//        User::create(["identity" => "100000339207179", "username" => "vy.le.96995", "fullname" => "Vy Vy Le", "gender" => "FEMALE", "birthday" => "1982", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100000334878230", "username" => "vu.huyen.1614", "fullname" => "Vũ Huyền", "gender" => "FEMALE", "location" => "Hanoi, Vietnam", "hometown" => "Bac Ninh", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "1017051403", "username" => "moon.hang.351", "fullname" => "Giang Khánh Hằng", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100004348592942", "username" => "100004348592942", "fullname" => "Đỗ Quyên Trắng", "gender" => "FEMALE", "location" => "Hanoi, Vietnam", "hometown" => "Hanoi, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
...
//        User::create(["identity" => "725112966", "username" => "725112966", "fullname" => "Đoàn Tiến Đạt", "gender" => "MALE", "location" => "Thành phố Hồ Chí Minh, Hồ Chí Minh, Vietnam", "hometown" => "Nam Dinâ?, Ha Nam Ninh, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "1131143118", "username" => "oc.thanhvan", "fullname" => "Phạm Thị Thanh Vân", "gender" => "FEMALE", "birthday" => "1984", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Hai Phong, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "746050202", "username" => "X.Nicky", "fullname" => "Vu Le Quoc", "gender" => "MALE", "birthday" => "1985", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "100003382890020", "username" => "perla.thai", "fullname" => "Ngoc Thai", "gender" => "FEMALE", "location" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
//        User::create(["identity" => "717678376", "username" => "thanhthaomc", "fullname" => "Nguyễn Ngọc Thanh Thảo", "gender" => "FEMALE", "birthday" => "1981", "location" => "Ho Chi Minh City, Vietnam", "hometown" => "Ho Chi Minh City, Vietnam", "hobbies" => $this->getHobbies(), 'jobs' => $this->getJobs()]);
